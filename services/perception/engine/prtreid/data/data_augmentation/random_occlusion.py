...
import PIL.Image
try:
    from albumentations import DualTransform, functional
except ImportError:      # albumentations >= 2 dropped the top-level alias;
    from albumentations import DualTransform   # the name is unused here anyway
    functional = None
