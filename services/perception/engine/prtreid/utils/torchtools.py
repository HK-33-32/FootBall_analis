...
def load_checkpoint(fpath):
    ...
    Examples::
        >>> from prtreid.utils import load_checkpoint
    ...
    try:
        # torch >= 2.6 defaults to weights_only=True; these are our own weights
...
def resume_from_checkpoint(fpath, model, optimizer=None, scheduler=None):
    ...
    Examples::
        >>> from prtreid.utils import resume_from_checkpoint
        >>> fpath = 'log/my_model/model.pth.tar-10'
...
def open_all_layers(model):
    ...
    Examples::
        >>> from prtreid.utils import open_all_layers
...
def open_specified_layers(model, open_layers):
    ...
    Examples::
        >>> from prtreid.utils import open_specified_layers
...
def count_num_param(model):
    ...
    Examples::
        >>> from prtreid.utils import count_num_param
...
def load_pretrained_weights(model, weight_path):
    ...
    Examples::
        >>> from prtreid.utils import load_pretrained_weights
